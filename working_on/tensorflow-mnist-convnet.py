...
x = tf.placeholder(tf.float32, [None, hy_parm['input_dim']])
...
W_conv1 = weight_variable(hy_parm['conv1_shape'])
b_conv1 = bias_variable(hy_parm['conv1_shape'][3])
...
W_conv2 = weight_variable(hy_parm['conv2_shape'])
b_conv2 = bias_variable(hy_parm['conv2_shape'][3])
...
print("conv2::",h_conv2.shape,">>",h_pool2.shape)
...
print("h_fc1::",h_pool2_flat.shape,">>",h_fc1.shape)
